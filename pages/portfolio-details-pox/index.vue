<template>
  <div>
    <BreadCrumbs title="Portfolio Details"/>
    <section id="portfolio-details" class="portfolio-details">
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-8">
           <PortfolioSwiper :images="images"/>
          </div>
          <div class="col-lg-4">
           <PortfolioDetails :info="info"/>
          </div>
        </div>
      </div>
    </section>
...
import PortfolioDetails from '@/components/page/portfolioDetails/portfolioDetails'
import PortfolioSwiper from '@/components/page/portfolioDetails/portfolioSwiper'
export default {
  name: 'portfolioDetailsPox',
  layout: 'main',
  components: {
    BreadCrumbs,PortfolioDetails,PortfolioSwiper
  },
  data(){
    return{
      info: {
      ...
      images:[
        {title:'portfolio-4.jpg'},
        {title:'portfolio-4-pox-0.jpg'},
        {title:'portfolio-4-pox-1.gif'}
      ]
    }
  }
}
